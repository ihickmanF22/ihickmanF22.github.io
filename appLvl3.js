...
function preload() {
	this.load.image('codey', 'assets/images/codey2.png');
	this.load.image('platform', 'assets/images/platform.png');
	this.load.image('sideBorder', 'assets/images/trans_vertform1.png');
	this.load.image('vertform', 'assets/images/trans_vertform2.png');
  ...
  const container = this.add.container(0, 0, [ wings ]);
	...
	for (let yVal = 1; yVal < 4; yVal++) {
		for (let xVal = 1; xVal < 9; xVal++) {
			gameState.enemies.create(50 * xVal, 50 * yVal, 'bug4').setScale(.6).setGravityY(-200);
		}
	}
